...
import { AppDatePicker, AppInput } from "@/components/shared/Form";
import { FREE_COUNT_MAX, FREE_COUNT_MIN, type FormState, type TronGasT } from "../state";
...
export const FreeQuotaConfigurationCard = ({ t, form, setForm, canManage }: Props) => {
  return (
    <AppCardLayout
      icon={
