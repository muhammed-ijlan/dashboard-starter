...
import { Zap, TrendingUp, CircleCheckBig, X } from "lucide-react";
...
import { formatTrx, type FormState, type TronGasT } from "../state";
...
export const GasFeeConfigurationCard = ({
  ...
  return (
    ...
    >
      ...
      >
        {form.energyOptimizationEnabled ? <CircleCheckBig size={20} /> : <X size={20} />}
